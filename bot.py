...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # record_video_dir is crucial for debugging errors on GitHub
        ...
        for i, yt_link in enumerate(links):
            ...
            if not email:
                print(f"[{i+1}] ❌ Failed to get burner email.")
                continue

            try:
                print(f"\n[{i+1}] Target: {yt_link} | Email: {email}")
                ...
                code = None
                for _ in range(20): # Increased wait for slow emails
                ...
                await asyncio.sleep(10) # Enough time for validation
                
                # Specifically targeting the main action button
                ...
                try:
                    ...
                    # If it fails, take a screenshot for debugging
